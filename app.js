function drawing(size) {
    ...
    if (size == 32) {
		let width = bigSquare[0].length,
			height = bigSquare.length;
			field.width = scale * width;
			field.height = scale * height;
        for (let row = 0; row < height; row++) {
            for (let col = 0; col < width; col++) {
...
let sizeSwitcher = document.querySelectorAll('.switcher__size');
let checkbox = document.querySelectorAll('.switcher__size_checkbox');
